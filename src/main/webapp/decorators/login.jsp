...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="'/template/admin/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet"  href="<c:url value='/template/admin/assets/vendor/css/pages/page-auth.css'/>"/>
    <link rel="stylesheet"  href="<c:url value='/template/admin/assets/vendor/css/pages/page-misc.css'/>"/>
