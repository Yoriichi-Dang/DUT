...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">${model.name} /</span> Lớp</h4>
    <div class="card">
        <h5 class="card-header">Danh sách các lớp trong ngành ${model.name}</h5>
        <div class="card-body">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-hover">
                ...
                <c:forEach var="item" items="${model.classModelList}" varStatus="loop">
