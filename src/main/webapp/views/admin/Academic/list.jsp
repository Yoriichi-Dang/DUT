...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Khoa /</span> Ngành</h4>
    <div class="card">
        <h5 class="card-header">Danh sách các ngành</h5>
        <div class="card-body">
            <div class="row gy-3">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel1">Thêm Mới Ngành</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col mb-3">
                                                <label for="idAcademic" class="form-label">Mã Ngành</label>
                                                <input name="id" type="text" id="idAcademic" class="form-control" placeholder="Nhập mã " required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
                                                <label for="nameAcademic" class="form-label">Tên Ngành</label>
                                                <input name="name" type="text" id="nameAcademic" class="form-control" placeholder="Nhập tên " required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="item" items="${model.list}" varStatus="loop">
                    ...
                    <tr>
                        ...
                        <td>${item.name}</td>
                        <td><a href="<c:url value='/admin-academic-page?type=listclass&id=${item.id}'/>" class="btn rounded-pill btn-primary">Xem</a></td>
                        <td>
                            <div class="dropdown">
...
<script>
    ...
    function addRowToTable(academic,index) {
        ...
        var row = '<tr>' +
            ...
            '</button>' +
            '<div class="dropdown-menu">' +
            '<a class="dropdown-item" href="/DUT/admin-faculty-page?type=edit&id='+academic.id+'"><i class="bx bx-edit-alt me-1"></i> Edit</a>' +
            '<a class="dropdown-item"  href="/DUT/admin-faculty-page?type=delete&id='+academic.id+'"><i class="bx bx-trash me-1"></i> Delete</a>' +
            '</div>' +
            '</div>' +
            '</td>' +
            '</tr>';
