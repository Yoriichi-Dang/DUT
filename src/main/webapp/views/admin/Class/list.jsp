...
<c:url var="APIurl" value="/api-admin-class"></c:url>
<html>
<head>
  <title>Title</title>
</head>
...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ngành /</span> Lớp</h4>
  <div class="card">
    <h5 class="card-header">Danh sách các lớp</h5>
    <div class="card-body">
      <div class="row gy-3">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Thêm Mới Lớp</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <div class="row">
                      <div class="col mb-3">
                        <label for="codeClass" class="form-label">Mã Lớp</label>
      ...
      <table class="table table-hover">
        ...
        <c:forEach var="item" items="${model.list}" varStatus="loop">
          ...
          <tr>
            ...
            <td><a href="<c:url value='/admin-class-page?type=liststudent&id=${item.id}'/>" class="btn rounded-pill btn-primary">Xem</a></td>
            <td>
              <div class="dropdown">
...
<script>
  ...
  function addRowToTable(item,index) {
    ...
    var row = '<tr>' +
            ...
            '</button>' +
            '<div class="dropdown-menu">' +
            '<a class="dropdown-item" href="/admin-class-page?type=edit&id='+item.id+'"><i class="bx bx-edit-alt me-1"></i> Edit</a>' +
            '<a class="dropdown-item"  href="/admin-class-page?type=delete&id='+item.id+'"><i class="bx bx-trash me-1"></i> Delete</a>' +
            '</div>' +
            '</div>' +
            '</td>' +
            '</tr>';
