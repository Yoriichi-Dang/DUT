...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Lớp /</span> Sinh viên</h4>
  <div class="card">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col mb-3">
                        ...
                        <input name="mssv" type="text" id="mssv" class="form-control" placeholder="Nhập mã số sinh viên" required>
                      </div>
                    </div>
                    <div class="row g-2">
                      <div class="col mb-3">
                        <label for="name" class="form-label">Tên</label>
                        <input name="name" type="text" id="name" class="form-control" placeholder="Nhập tên sinh viên" required>
                      </div>
                      <div class="col mb-3">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <label for="EnrollmentYear" class="form-label">Năm nhập học</label>
                        <input name="name" type="number" id="EnrollmentYear" class="form-control"  min="23" required>
                      </div>
                      <div class="col-md-6 mb-3">
      ...
      <table class="table table-hover">
        ...
        <c:forEach var="item" items="${model.list}" varStatus="loop">
          ...
          <tr>
            ...
            <td> <span class="badge bg-label-${bg} me-1">${item.classCode}</span></td>
            <td><span class="badge bg-label-${bg} me-1">${item.academicModel.name}</span></td>
            <td>${item.city}</td>
            <td><span class="badge bg-label-${bg} me-1">${item.yearStudy}</span></td>
...
<script>
  ...
  function addRowToTable(item, index) {
    ...
    var linkEdit = "/DUT/admin-student-page?type=edit&id=" + item.id;
