...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card overflow-hidden mb-4" style="height: 690px;">
        ...
        <div class="card-body vertical-scrollbar" id="vertical-example">
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <c:forEach var="item" items="${educationCourse}" varStatus="loop">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${item.dependentList_courseStudyBeforeCode!=null}">
                                    <c:forEach var="course" items="${item.dependentList_courseStudyBeforeCode}" varStatus="loop">
                                        ${course.name}<br>
                                    </c:forEach>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${item.dependentList_courseStudyTogetherCode!=null}">
                                    <c:forEach var="course" items="${item.dependentList_courseStudyTogetherCode}" varStatus="loop">
                                        ${course.name}<br>
                                    </c:forEach>
                                </c:if>
                            </td>
                            <td> ${item.courseModel.pointStudy}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
