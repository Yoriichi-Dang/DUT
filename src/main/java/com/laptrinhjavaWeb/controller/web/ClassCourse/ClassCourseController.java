package com.laptrinhjavaWeb.controller.web.ClassCourse;
...
@WebServlet(urlPatterns = {"/home-class-course-page"})
...
public class ClassCourseController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String views="/views/web/ClassCourse/list.jsp";
        ...
        if(classCourseModel.getType()==null){
            ...
            if(classCourseModel.getList()!=null){
                ...
                views="/views/web/ClassCourse/listStudentClassCourse.jsp";
            }
